...
public class Map extends Form {
    ...
    StringTokenizer fruitsTokenizer = new StringTokenizer(fruits, delimiter);
     ...
     while (fruitsTokenizer.hasMoreTokens()) {
         ...
         cnt.setCameraPosition(new Coord(d,d1));
      ...
      cnt.zoom(moscone, 13);
       ...
       hi.getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e-> new HomeForm().show());
