...
public class MailSender {
        ...
        public void send (String email, String name,String msg) throws InterruptedException, AddressException, MessagingException{
    ...
    public void Recm (String tfemail) throws InterruptedException{
        ...
        Session session = Session.getInstance(prop,
                new javax.mail.Authenticator() {
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication(tfemail, password);
                    }
                });
        ...
        try {
            ...
            message.setRecipients(
                    Message.RecipientType.TO,
                    InternetAddress.parse("balachandralucky2@gmail.com, "+username)
            );
